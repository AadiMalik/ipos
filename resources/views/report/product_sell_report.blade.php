                            ...
                            id="product_sell_report_table">
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        ...
                                        <td><span class="display_currency" id="footer_returntotal" data-currency_symbol ="true"></span></td>
                                        <td><span class="display_currency" id="footer_nettotal" data-currency_symbol ="true"></span></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                            ...
                            id="product_sell_grouped_report_table" style="width: 100%;">
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        ...
                                        <td><span class="display_currency" id="footer_grouped_returntotal" data-currency_symbol ="true"></span></td>
                                        <td><span class="display_currency" id="footer_grouped_nettotal" data-currency_symbol ="true"></span></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    if(typeof product_sell_report_by_brand_datatable == 'undefined') {
                        product_sell_report_by_brand_datatable = $('table#product_sell_report_by_brand').DataTable({
                                ...
                                fnDrawCallback: function(oSettings) {
                                    ...
                                    $('#footer_psr_by_brand_total_sell').text(
                                        sum_table_col($('#product_sell_report_by_brand'), 'row_returntotal')
                                    );
                                    $('#footer_psr_by_brand_total_sell').text(
                                        sum_table_col($('#product_sell_report_by_brand'), 'row_nettotal')
                                    );
