...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/test-mra', [BusinessController::class, 'testMraConnection']);
    ...
    Route::post('/sells/send-invoice-whatsapp', [SellController::class, 'sendInvoiceWhatsapp']);
    ...
    Route::get('/reports/agent-commission-report', [ReportController::class, 'agentCommissionReport']);
    ...
    Route::get('/reports/customer-sale-ledger-report', [ReportController::class, 'getCustomerSaleLedgerReport']);
